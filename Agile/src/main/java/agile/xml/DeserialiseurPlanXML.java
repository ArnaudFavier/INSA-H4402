...
public class DeserialiseurPlanXML extends DefaultHandler {
	...
	/**
	 * Le plan cr�� � la fin du parsing
	 */
	private Plan plan;

	/**
	 * Les intersections en fonction des ids, utilis� pendant le parsing
	 */
	...
	/**
	 * Permet le chargement d'un plan, ouvre une fen�tre FileChooser dans
	 * laquelle il faut choisir un xml de plan
	 * 
	 * @return Le plan cr�� � partir du xml
	 * @throws SAXException
	...
	/**
	 * Permet le chargement d'un plan a partir d'un fichier pass� en param�tre
	 * 
	 * @param file
