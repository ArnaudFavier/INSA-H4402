...
public final class DialogNouvelleLivraison {
	...
	Label labelPlage = new Label("Plage horaire : ");
	...
	grid.add(labelPlage, 1, 3);
	grid.add(textPlageDebut, 2, 3);
	grid.add(textPlageFin, 3, 3);
	...
	boutonValider.setOnAction(new EventHandler<ActionEvent>() {
		...
		if (!error) {
		    ...
		    Livraison livraison = new Livraison(duree, inter, plageDebut, plageFin);
